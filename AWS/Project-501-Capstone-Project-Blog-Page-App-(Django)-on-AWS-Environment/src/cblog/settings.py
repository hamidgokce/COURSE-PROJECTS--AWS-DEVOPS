...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cobrm646hkcz.us-east-2.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstones3hamidblog' # please enter your s3 bucket name
